...
function replaceExports(node, path) {
    const objName = (0, get_1.getSafe)(node, 'left.object.name');
    const name = (0, get_1.getName)(node, 'left.property');
    if (node.operator === '=') {
        if (objName === 'exports') {
            ...
            if ((0, get_1.getName)(node, 'right.object') === 'exports' && (0, get_1.getName)(node, 'right.property') === 'default') {
