...
exports.namespaceImportVisitors = {
    ImportDeclaration(path) {
        ...
        const newNode = t.importDeclaration([t.importDefaultSpecifier(t.identifier(originalSpecifier.local.name))], t.stringLiteral(originalNode.source.value));
