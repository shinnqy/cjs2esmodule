...
exports.transformFiles = exports.transformNamespaceImport4esbuild = exports.cjs2esm4esbuild = exports.cjs2esmVitePlugin = void 0;
const fs = __importStar(require("fs"));
const base_1 = require("./utils/base");
const visitors_1 = require("./visitors");
const transformFileBase = (0, base_1.generateTransformer)(visitors_1.cjs2esmVisitors);
const transformNamespaceImport = (0, base_1.generateTransformer)(visitors_1.namespaceImportVisitors);
/**
 *
 * @param sourceDir
 * @returns
...
function cjs2esmVitePlugin({ sourceDir = 'src' } = {}) {
    return {
        ...
        transform(src, id) {
            ...
            if (/\.js$/g.test(id) && id.startsWith(ROOT) && (0, base_1.isCjsFile)(src)) {
